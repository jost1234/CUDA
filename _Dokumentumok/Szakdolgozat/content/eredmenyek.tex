...
\subsection{CVRP}
Az első feltételes útvonaltervezést igénylő algoritmus a kapacitásos járműútvonal-tervezés. Adathalmazt a következő helyről szedtem: \cite{CVRPdataset}.
...
\begin{table}[ht!]
	...
	\begin{tabular}{|p{1.75cm}||p{2cm}|p{3.25cm}|p{3.25cm}|p{1.5cm}|}
		...
		\hline
	\end{tabular}
	\caption{A szigorúbb időablakokkal bíró adathalmaz első 26 csúcsára vett rendezett kereséses CVRPTW mérés}
...
\begin{table}[ht!]
	...
	\begin{tabular}{|p{1.75cm}||p{2cm}|p{3.25cm}|p{3.25cm}|p{1.5cm}|}
		\hline
		\multicolumn{5}{|c|}{C101.50: 51 csúcs, minimális út: 362.4} \\
		\hline
		& Futásidő (s) & Végeredmény átlag & Végeredmény min. & Hiba(\%) \\
		\hline
		\textbf{10 rep} &  &  &  & \\
		...
		\hline
	\end{tabular}
	\caption{ A szigorúbb időablakokkal bíró adathalmaz első 51 csúcsára vett rendezett kereséses CVRPTW mérés}
	\label{table:VRTPW2_50_1}
\end{table}
...
\begin{table}[ht!]
	...
	\begin{tabular}{|p{1.75cm}||p{2cm}|p{3.25cm}|p{3.25cm}|p{1.5cm}|}
		\hline
		\multicolumn{5}{|c|}{C101.100: 101 csúcs, minimális út: 827.3} \\
		\hline
		& Futásidő (s) & Végeredmény átlag & Végeredmény min. & Hiba(\%) \\
		\hline
		\textbf{10 rep} &  &  &  & \\
		...
		\hline
	\end{tabular}
	\caption{A szigorúbb időablakokkal bíró adathalmaz teljes egészére vett rendezett kereséses CVRPTW mérés}
	\label{table:VRTPW2_100_1}
\end{table}
...
\begin{table}[ht!]
	...
	\begin{tabular}{|p{1.75cm}||p{2cm}|p{3.25cm}|p{3.25cm}|p{1.5cm}|}
		...
		\hline
		\textbf{50 rep} &  &  &  &  \\
		20480 ant & 1989 & 2003,4 (+240\%) & 1476,6 (+150\%) & 10\% \\
		\hline
		\textbf{70 rep} &  &  &  &  \\
		20480 ant &  &  &  &  \% \\
		\hline
