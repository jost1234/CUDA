...
A koncepció központi elemei a \textbf{feromonok}, melyek biokommunikációra szolgáló, különböző állatok, rovarok által a külvilágba bocsátott kémiai anyagok, amelyek a faj másik egyedéből meghatározott viselkedést váltanak ki.
...
\begin{itemize}
	...
	\item VRP - Vehicle Routing Problems: Jármű útvonaltervezési problémák
	\item CVRP
	\item CRPTW
	\item CPU - 
	\item GPU
	\item CUDA - Compute valami
